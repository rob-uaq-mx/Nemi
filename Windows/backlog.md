...
> **82/82** en total. Esta versión también agrega `WinNemi.exe` (editor +
> consola), fuera del alcance de este backlog — ver el resto de este archivo
> solo para el port del núcleo del intérprete.
