...
// CmdLineCtl.c is compiled as C, giving these symbols C linkage. A C++
// translation unit including this header directly (WinNemi, which embeds
// the C++ Nemi interpreter) would otherwise see name-mangled declarations
// that don't match at link time -- hence the extern "C" guard below.
#ifdef __cplusplus
extern "C" {
#endif
